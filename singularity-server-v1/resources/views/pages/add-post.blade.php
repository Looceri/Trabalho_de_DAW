                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ isset($post) ? route('update-post', $post->id) : route('store-post') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control" name="url_image" id="url_image" accept="image/*">
                                        @if(isset($post) && $post->url_image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/'.$post->url_image) }}" alt="Imagem do Post" style="max-width: 150px;">
                                            </div>
                                        @endif
                                    </div>
                                </div>
