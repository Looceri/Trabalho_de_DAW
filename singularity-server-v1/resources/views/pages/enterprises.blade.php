    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Empresas</h1>
                </div>
                <!-- End Col -->

                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('add-user') }}">
                        <i class="bi-person-plus-fill me-1"></i> Adicionar Empresa
                    </a>
                </div>
                <!-- End Col -->
            </div>
        ...
        <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">Total De Empresas</h6>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="table-column-ps-0">
                            <a class="d-flex align-items-center" href="{{ route('enterprise-details') }}">
