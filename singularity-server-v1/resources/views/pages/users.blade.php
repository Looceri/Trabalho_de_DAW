                    ...
                    {{-- <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="usersExportDropdown">
                            ...
                            <a id="export-copy" class="dropdown-item" href="javascript:;">
                                <img class="avatar avatar-xss avatar-4x3 me-2" src="{{ asset('template/admin/assets/svg/illustrations/copy-icon.svg') }}"
                                    alt="Image Description">
                                Copy
                            </a>
                            <a id="export-print" class="dropdown-item" href="javascript:;">
                                <img class="avatar avatar-xss avatar-4x3 me-2" src="{{ asset('template/admin/assets/svg/illustrations/print-icon.svg') }}"
                                    alt="Image Description">
                                Print
                            </a>
                            ...
                            <a id="export-excel" class="dropdown-item" href="javascript:;">
                                <img class="avatar avatar-xss avatar-4x3 me-2" src="{{ asset('template/admin/assets/svg/brands/excel-icon.svg') }}"
                                    alt="Image Description">
                                Excel
                            </a>
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-sm avatar-circle">
                                                ...
                                                <img class="avatar-img"
                                                    src="{{ asset($user->avatar_image ? 'storage/' . $user->avatar_image->path : 'assets/img/160x160/img1.jpg') }}"
                                                    alt="Image Description">
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                      ...
                      "hideSearch": true
                                    ...
                                    <option value="{{ $totalUsers }}"
                                        {{ $initialDisplay == $totalUsers ? 'selected' : '' }}>{{ $totalUsers }}
                                    </option>
                                </select>
                            </div>
                            <!-- End Select -->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <p class="fs-6 mb-0">&copy; Todos os direitos reservados. Feito pela <a
                            class="d-none d-sm-inline-block nav-link d-inline fw-normal p-0 ms-1" href="#"
                            target="_blank" rel="noopener" style="color: #377dff;">Singularity Inc.</a></p>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content" id="editUserModalTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel"
                              ...
                              "allowTypes": [".png", ".jpeg", ".jpg"]
                                    ...
                                    <!-- Form -->
                                    <div class="row mb-4">
                                        <label for="editFirstNameModalLabel"
                                            class="col-sm-3 col-form-label form-label">Nome
                               ...
                               "placeholder": "Select country"
                                    ...
                                    Mozambique</option> --}}
                                            ...
                                            <input type="text" class="form-control" name="editStateModal"
                                                id="editStateModalLabel" placeholder="Provincia"
                            ...
                            <div class="tab-pane fade" id="notifications" role="tabpanel"
                                ...
                                <div class="table-responsive datatable-custom">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Um novo dispositivo conectado <i
                                ...
                                <div class="row">
                                  ...
                                  "hideSearch": true
                                    ...
                                    <div class="col-sm">
                                        <!-- Formulário -->
                                        <div class="mb-4">
                                            <span class="d-block mb-2">Enviar um resumo diário ("Resumo Diário") da
                                                atividade
                                                da tarefa.</span>
                                ...
                                <p>Para reduzir o ruído, as notificações por e-mail são agrupadas e enviadas apenas quando
                                    você
                                    está
                                    inativo
                                    ou offline.</p>
